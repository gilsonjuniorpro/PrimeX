...
package primex.ca.data.remote

import primex.ca.BuildConfig
import primex.ca.data.remote.response.CastResponse
import primex.ca.data.remote.response.FilmResponse
import primex.ca.data.remote.response.GenreResponse
import primex.ca.data.remote.response.MultiSearchResponse
...
interface APIService {
    ...
    suspend fun getTrendingMovies(
        ...
        @Query("api_key") apiKey: String = BuildConfig.PRIME_X_API_KEY,
